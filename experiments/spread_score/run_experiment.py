...
=======================================
Builds on `experiments/catboost_leaf_embeddings`: a heavily-regularised
...
Outputs (experiments/spread_score/outputs/):
  results.csv
  learnability_r2.png
...
# ---------------------------------------------------------------------------
# Configuration (mirrors experiments/catboost_leaf_embeddings for comparability)
# ---------------------------------------------------------------------------
...
def _write_report(df: pd.DataFrame) -> None:
    ...
    lines: list[str] = [
        ...
        "",
        "> Generated by `experiments/spread_score/run_experiment.py`",
        "",
        "---",
        "",
        "## Question",
        "",
        "`experiments/catboost_leaf_embeddings` showed the *kernel score* (a kernel-weighted",
    ...
    lines += [
        ...
        "   `catboost_leaf_embeddings/report.md`), yet large enough that every definition is",
