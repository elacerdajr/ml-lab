"""
experiments/risk_uncertainty/run_experiment.py
----------------------------------------------
...
"""
    ...
    report = f"""\
# Knightian Risk vs Uncertainty — Experiment Report
...
| File | Description |
| --- | --- |
| `fig1_test_auc_and_gap.png` | Test AUC and generalization gap, all models × scenarios |
| `fig2_calibration_variance.png` | Calibration error and bootstrap AUC variance |
| `fig3_regime_performance.png` | Per-regime AUC for scenario 3 |
| `fig4_summary_heatmap.png` | Heatmap of all four metrics, models × scenarios |
| `fig5_test_ap.png` | Average Precision by model and scenario |
